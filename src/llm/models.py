...
def get_model(
    ...
    if model_provider == ModelProvider.GROQ:
        ...
        if not api_key:
            ...
            print(
                "API Key Error: Please make sure GROQ_API_KEY is set"
                " in your .env file or provided via API keys."
            )
            raise ValueError(
                "Groq API key not found.  Please make sure GROQ_API_KEY"
                " is set in your .env file or provided via API keys."
            )
        ...
        if not api_key:
            # Print error to console
            print(
                "API Key Error: Please make sure OPENAI_API_KEY is set"
                " in your .env file or provided via API keys."
            )
            raise ValueError(
                "OpenAI API key not found.  Please make sure OPENAI_API_KEY"
                " is set in your .env file or provided via API keys."
            )
        ...
        if not api_key:
            print(
                "API Key Error: Please make sure ANTHROPIC_API_KEY is set"
                " in your .env file or provided via API keys."
            )
            raise ValueError(
                "Anthropic API key not found.  Please make sure ANTHROPIC_API_KEY"
                " is set in your .env file or provided via API keys."
            )
        ...
        if not api_key:
            print(
                "API Key Error: Please make sure DEEPSEEK_API_KEY is set"
                " in your .env file or provided via API keys."
            )
            raise ValueError(
                "DeepSeek API key not found.  Please make sure DEEPSEEK_API_KEY"
                " is set in your .env file or provided via API keys."
            )
        ...
        if not api_key:
            print(
                "API Key Error: Please make sure GOOGLE_API_KEY is set"
                " in your .env file or provided via API keys."
            )
            raise ValueError(
                "Google API key not found.  Please make sure GOOGLE_API_KEY"
                " is set in your .env file or provided via API keys."
            )
        ...
        if not api_key:
            print(
                "API Key Error: Please make sure OPENROUTER_API_KEY is set"
                " in your .env file or provided via API keys."
            )
            raise ValueError(
                "OpenRouter API key not found. Please make sure OPENROUTER_API_KEY"
                " is set in your .env file or provided via API keys."
            )
        ...
        if not api_key:
            print(
                "API Key Error: Please make sure XAI_API_KEY is set"
                " in your .env file or provided via API keys."
            )
            raise ValueError(
                "xAI API key not found. Please make sure XAI_API_KEY"
                " is set in your .env file or provided via API keys."
            )
        ...
        if os.getenv("GIGACHAT_USER") or os.getenv("GIGACHAT_PASSWORD"):
            ...
            if not api_key:
                print(
                    "API Key Error: Please make sure api_keys is set"
                    " in your .env file or provided via API keys."
                )
                raise ValueError(
                    "GigaChat API key not found. Please make sure GIGACHAT_API_KEY"
                    " is set in your .env file or provided via API keys."
                )
        ...
        if not api_key:
            # Print error to console
            print(
                "API Key Error: Please make sure AZURE_OPENAI_API_KEY"
                " is set in your .env file."
            )
            raise ValueError(
                "Azure OpenAI API key not found.  Please make sure"
                " AZURE_OPENAI_API_KEY is set in your .env file."
            )
        ...
        if not azure_endpoint:
            # Print error to console
            print(
                "Azure Endpoint Error: Please make sure"
                " AZURE_OPENAI_ENDPOINT is set in your .env file."
            )
            raise ValueError(
                "Azure OpenAI endpoint not found.  Please make sure"
                " AZURE_OPENAI_ENDPOINT is set in your .env file."
            )
        ...
        if not azure_deployment_name:
            # Print error to console
            print(
                "Azure Deployment Name Error: Please make sure"
                " AZURE_OPENAI_DEPLOYMENT_NAME is set in your .env file."
            )
            raise ValueError(
                "Azure OpenAI deployment name not found.  Please make sure"
                " AZURE_OPENAI_DEPLOYMENT_NAME is set in your .env file."
            )
