...
ANALYST_CONFIG = {
    "aswath_damodaran": {
        ...
        "investing_style": (
            "Focuses on intrinsic value and financial metrics to assess"
            " investment opportunities through rigorous valuation analysis."
        ),
    ...
    "ben_graham": {
        ...
        "investing_style": (
            "Emphasizes a margin of safety and invests in undervalued companies"
            " with strong fundamentals through systematic value analysis."
        ),
    ...
    "bill_ackman": {
        ...
        "investing_style": (
            "Seeks to influence management and unlock value through strategic"
            " activism and contrarian investment positions."
        ),
    ...
    "cathie_wood": {
        ...
        "investing_style": (
            "Focuses on disruptive innovation and growth, investing in companies"
            " that are leading technological advancements and market disruption."
        ),
    ...
    "charlie_munger": {
        ...
        "investing_style": (
            "Advocates for value investing with a focus on quality businesses"
            " and long-term growth through rational decision-making."
        ),
    ...
    "michael_burry": {
        ...
        "investing_style": (
            "Makes contrarian bets, often shorting overvalued markets and investing"
            " in undervalued assets through deep fundamental analysis."
        ),
    ...
    "mohnish_pabrai": {
        ...
        "investing_style": (
            "Focuses on value investing and long-term growth through"
            " fundamental analysis and a margin of safety."
        ),
    ...
    "nassim_taleb": {
        ...
        "investing_style": (
            ...
            " Uses barbell strategy, avoids fragile companies via negativa,"
            " and seeks convex positions with limited downside and unlimited upside."
        ),
    ...
    "peter_lynch": {
        ...
        "investing_style": (
            "Invests in companies with understandable business models and strong"
            " growth potential using the 'buy what you know' strategy."
        ),
    ...
    "technical_analyst": {
        ...
        "investing_style": (
            "Focuses on chart patterns and market trends to make investment decisions,"
            " often using technical indicators and price action analysis."
        ),
    ...
    "fundamentals_analyst": {
        ...
        "investing_style": (
            ...
            " the intrinsic value of companies through fundamental analysis."
        ),
    ...
    "growth_analyst": {
        ...
        "investing_style": (
            "Analyzes growth trends and valuation to identify growth"
            " opportunities through growth analysis."
        ),
    ...
    "sentiment_analyst": {
        ...
        "investing_style": (
            ...
            " movements and identify opportunities through behavioral analysis."
        ),
    ...
    "valuation_analyst": {
        ...
        "investing_style": (
            "Specializes in determining the fair value of companies, using various"
            " valuation models and financial metrics for investment decisions."
        ),
